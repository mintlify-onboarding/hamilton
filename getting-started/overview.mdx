...
Before diving in, we highly recommend you try Hamilton in your browser at https://www.tryhamilton.dev. It allows you to:
...
3. it represents an easy hands-on introduction to Hamilton that should get you comfortable with the framework and its basic capabilities.
